...
var map = {
	"../addquestion/addquestion.module": [
	...
	"../questionsadmin/questionsadmin.module": [
...
var routes = [
    ...
    { path: 'home', loadChildren: './home/home.module#HomePageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
    { path: 'admin', loadChildren: './admin/admin.module#AdminPageModule', canActivate: [_guards_auth_guard__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]] },
    { path: 'login', loadChildren: './login/login.module#LoginPageModule' },
    { path: 'register', loadChildren: './register/register.module#RegisterPageModule' },
    { path: 'addquestion', loadChildren: './addquestion/addquestion.module#AddquestionPageModule' },
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (regno, password) {
        var _this = this;
        return this.http.post(this.apiUri + "/api/user/authenticate", { regno: regno, password: password })
...
module.exports = __webpack_require__(/*! F:\Malith\CSUP Projects\QuestonBank\frontend\src\main.ts */"./src/main.ts");
