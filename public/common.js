...
var QuestionService = /** @class */ (function () {
    ...
    QuestionService.prototype.getQuestions = function () {
        return this.http.get(this.uri + "/api/question");
    };
    QuestionService.prototype.deleteQuestion = function (id) {
        return this.http.post(this.uri + "/api/question/delete", { id: id });
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getUsers = function () {
        return this.http.get(this.uri + "/api/user/all");
    };
    UserService.prototype.getUser = function (regno) {
        return this.http.get(this.uri + "/api/user/?regno=" + regno);
    };
    UserService.prototype.deleteUser = function (regNo) {
        return this.http.post(this.uri + "/api/user/delete", { regno: regNo });
    };
    UserService.prototype.updateUser = function (regno, status) {
        var data = {
            regno: regno,
            status: status
        };
        return this.http.post(this.uri + "/api/user/update", data);
    };
